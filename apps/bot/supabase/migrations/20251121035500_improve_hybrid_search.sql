-- Improve search_notes_hybrid to include ILIKE for better keyword recall
-- This ensures that exact substring matches are always returned, even if trigram similarity is low
