...
describe('LinkExtractor', () => {
  describe('extractAndValidateUrls', () => {
    ...
    it('should extract URLs with hyphens in path', () => {
      const text = 'Check this out: https://lucumr.pocoo.org/2025/6/12/agentic-coding/';
      const urls = linkExtractor.extractAndValidateUrls(text);

      expect(urls).toEqual(['https://lucumr.pocoo.org/2025/6/12/agentic-coding/']);
    });
